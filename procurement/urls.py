...
urlpatterns = [
    ...
    path('award-contract/<int:procurement_id>/', AwardContractorView.as_view(), name='award_contract'),
    path('contractor/awards/', ContractorAwardListView.as_view(), name='contractor_award_list'),
]
